...
<section class="container_page">
    ...
    <div class="row">
        <div class="divided">
            <article class="more">
                <h2 class="over"><span>Who am I</span></h2>
                <p>Hello! My name is Hugo Nicaise. I'm a web developer and audiovisual student based in Troyes, France. I started to create websites back in 2014 by curiosity to help my father, but since I never stopped. Beside my studies, I create websites and digital projects for professionals and individuals. I also create personal projects to keep on learning every single day because I love my job.</p>
            </article>
            <article class="more">

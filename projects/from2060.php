<article class="report">
    ...
    <section class="col-2">
        ...
        <h4 class="role">Role :<span>Lead developer & project manager</span></h4>
        <h4 class="role">Date :<span>November 2018</span></h4>
        <h4 class="role">Team :<span><strong>Graphic designer:</strong> Anthony Inciarte, <strong>Print:</strong> Nathan Dhaynaut, <strong>Composer:</strong> Alexander Ceccaldi, <strong>Script:</strong> Jules Belluz, <strong>Web designer: </strong>Romane Ledoux, <strong>Back-end developer:</strong> Antonin Touron</span></h4>
        <hr>
        <h2>CONTEXT</h2>
        <p>As a group of six students, we had to create an <strong>online puzzle game</strong>. To win, you must answer a series of riddles with an increasing difficulty. However, to be able to solve them, you must use a <strong>game board</strong> on which are displayed clues and game missing information. This hybrid game mixing <strong>digital and paper support</strong> gives you an immersing game-play breaking the <strong>fourth wall</strong>.</p>
        <hr>
        <h2>GAME SYNOPSIS</h2>
        <p>We are in 2060. Your name is <strong>Isaac</strong>, a young boy about twenty, and you lost your memory. When you wake up, <strong>RosAI</strong> an artificial intelligence asks help to you to <strong>accomplish a mission</strong> she cannot do alone. During this adventure, you will have to solve several <strong>riddles</strong> with her support.</p>
        <hr>
        <img src="img/riddle_from2060.png" />
        <p class="caption">— Security break riddle</p>
        <hr>
    ...
    <section class="col-2">
        ...
        <hr>
        <h2>DELIVERABLES</h2>
        <p>An online game, a promotional website, a game board, flyers, and a promotional campaign.</p>
        <hr>
        <img src="img/room.gif" alt="Isaac's room" />
        <p class="caption">— Isaac's room</p>
        <hr>
        <h2>MUSIC</h2>
        <p>In this project, we asked our composer to produce <strong>tracks</strong> specifically for the game, to increase the <strong>immersion</strong> of the player. Indeed, you can make the player feel exactly what you want him to feel when he is playing your game. It’s equally if not <strong>more important</strong> than the story itself. Feel free to listen <i>"Run!"</i>, one of the 12 game tracks.</p>
        <br>
        <p class="music">♫ Alexander Ceccaldi - <i>Run!</i><audio src="sound/drive.ogg" volume="0.1"></audio><img src="img/off.svg" /></p>
        <hr>
        <h2>GAME BOARD</h2>
        ...
        <hr>
        <img src="img/print_from2060.png" />
    </section>
</article>
<br>